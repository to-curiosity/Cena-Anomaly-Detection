...
- I suspect that implementing the model in Python with TensorFlow/Keras would be easier for development and wider accessibility. Training the model and saving the weights can be done. Then, perform the forward pass and inference using Go and the Lattigo library for secure and efficient execution of the pre-trained model.
